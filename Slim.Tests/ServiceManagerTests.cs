...
public class ServiceManagerTests
{
    ...
    [TestMethod]
    public void ServiceManager_SetsParentOfScopedManager()
    {
        var serviceManager = new ServiceManager();

        var scopedManager = serviceManager.CreateScope() as IServiceManager;

        scopedManager.ParentServiceManager.Should().Be(serviceManager);
    }

    [TestMethod]
    public void ServiceManager_ShouldHaveNoParent()
    {
        var serviceManager = new ServiceManager();
